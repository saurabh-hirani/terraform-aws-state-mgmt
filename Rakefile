...
def gen_tf_docs
  ...
  `terraform-docs md aws/remote_state  > aws/remote_state/TERRAFORM.md`
  `terraform-docs md aws/state_locking > aws/state_locking/TERRAFORM.md`
  `git add aws/remote_state/TERRAFORM.md`
  `git add aws/state_locking/TERRAFORM.md`
